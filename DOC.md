 # GOAT : System Architecture Document


## System Overview

GOAT trading platform is a decentralized perpetual futures trading platform built on Monad. The system leverages MON token staking to create a derivative token (hasMON) that serves as collateral for trading, while simultaneously generating yield ![alt text](image.png)for users through delegation mechanisms.
